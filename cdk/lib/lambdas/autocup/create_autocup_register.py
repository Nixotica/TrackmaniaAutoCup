...
def lambda_handler(event, context):
    ...
    registrationEnd = datetime.datetime.strftime(now + datetime.timedelta(days=6, hours=20), date_format)
    qualifierStart = datetime.datetime.strftime(now + datetime.timedelta(days=6, hours=20, minutes=1), date_format)
    qualifierEnd = datetime.datetime.strftime(now + datetime.timedelta(days=6, hours=20, minutes=2), date_format)
    round1Start = datetime.datetime.strftime(now + datetime.timedelta(days=6, hours=20, minutes=16), date_format)
    round1End = datetime.datetime.strftime(now + datetime.timedelta(days=6, hours=20, minutes=25), date_format)
    round2Start = datetime.datetime.strftime(now + datetime.timedelta(days=6, hours=20, minutes=26), date_format)
    round2End = datetime.datetime.strftime(now + datetime.timedelta(days=6, hours=20, minutes=35), date_format)
